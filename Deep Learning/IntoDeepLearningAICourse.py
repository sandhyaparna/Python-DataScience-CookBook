...
#Go throught all code notebooks in https://github.com/sandhyaparna/dlaicourse
...
# Stops training when I reach a point I want to be at based on callbacks. 
# In every epoch, you can callback to a code function, having checked the metrics, if they are reached, u can cancel training at that point
